var VILLAINS = ["Postmodern Neomarxists", "Feminists (who secretly crave domination)", "Leftist academics", "Dangerous ideologues", "Derrida and Foucault", "Indoctrinated students", "Social justice types", "Radical trans activists", "Politically correct HR departments", "Actual Communists", "<i>The</i> left", "Millennials with a victimhood mentality", "Universities under siege by ideological agendas", "Sad women complaining about the patriarchy", "The modern acolytes of Karl Marx", "So-called tolerant progressives", "Marxist professors teaching <i>Das Kapital</i>", "Need I mention that leftists", "Spoon-fed radical students", "The postmodernists who hate truth", "The 'tolerant' brainwashed masses", "Businesses infiltrated by Postmodern Neomarxists", "Progressives drunk on empathy", "The self-proclaimed diversity advocates", "Entitled progressive children", "Critics of free speech on campus", "Those who slander me", "My enemies on the radical left", "Ideological parents with a leftist agenda", "It's still shocking that campus radicals"];
...
var FAVORITE_THINGS = ["the dominance hierarchy", "the metaphorical substrate of our culture", "all Western values", "dream-like significance of revealed Truth", "the classical humanities", "the Enlightenment's progress", "the supreme importance of the individual", "the Hero's Journey", "the holistic fabric of Being", "the achievements of Judeo-Christian culture", "Solzhenitsyn's prudent warning in <i>The Gulag Archipelago</i>", "Carl Jung's legacy", "the divine Logos", "the embodiment of Christ", "the inescapable tragedy and suffering of life", "the transcendent architecture of Meaning", "the humble lobster's quest", "the <i>manifestations</i> of the divine", "the Jungian architecture of dreams", "the <i>masculine</i> ideal of Order", "the configurations of heroic Meaning", "Milo's message as a truth-telling trickster", "our most vital Biblical narratives", "Pareto distribution of achievement,", "the eternal structures of belief", "the old-school, empirical social sciences", "the Word <i>within</i> Genesis"];
